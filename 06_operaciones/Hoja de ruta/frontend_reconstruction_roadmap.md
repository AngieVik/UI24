...
| --- | --- | --- | --- |
| ~~D-01~~ | ~~Bypass~~ | ~~Eliminar bloque `Bypass de desarrollo` de `LoginScreen.tsx`~~ ✅ resuelto 2026-05-28. `buildFakeSession`, bloque JSX dev y `FlaskConical` eliminados de `LoginScreen.tsx`. |
