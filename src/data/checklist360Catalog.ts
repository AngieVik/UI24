...
export const CHECKLIST_SECTIONS: ChecklistSection[] = [
        ...
        subFields: [
          {
            ...
            label: 'Foco averiado',
            type: 'multiselect',
            options: ['Cruce Izq', 'Cruce Der', 'Largas Izq', 'Largas Der', 'Int. Izq D', 'Int. Der D', 'Antiniebla D'],
            required: true,
          },
          {
        ...
        subFields: [
          {
            ...
            label: 'Tipo de avería',
            type: 'multiselect',
            options: ['Módulo LED fundido', 'Rotura física/Impacto', 'Fallo de sincronización/Relé', 'Humedad interior/Empañamiento'],
            required: true,
          },
          {
            ...
            type: 'select',
            options: ['Parrilla Izquierda', 'Parrilla Derecha', 'Intersección Izq', 'Intersección Der'],
          },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        subFields: [
          ...
          },
          {
            ...
            type: 'select',
            options: ['Presión baja', 'Pinchazo activo', 'Desgaste por debajo del testigo (1.6mm)', 'Desgaste irregular (paralelo)'],
          },
        ],
      },
      {
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Corte profundo (mallas a la vista)', 'Deformación/Huevo', 'Roce severo por bordillo'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'multiselect',
            options: ['Conjunto', 'Espejo grande (arriba)', 'Carcasa luz intermitente', 'Carcasa espejo', 'Espejo pequeño (abajo)'],
            required: true,
          },
          {
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Atasco en carril/rodillos', 'Fallo en cierre centralizado', 'Tirador exterior roto', 'Bloqueo de seguridad (90º) inoperativo'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Motor atascado/quemado', 'Sensor de apertura fallido', 'Estructura doblada por impacto'],
            required: true,
          },
        ],
      },
  ...
  },
  {
    ...
    items: [
      {
        id: 'opticas_traseras',
        label: 'Funcionamiento de ópticas traseras (freno, marcha atrás, antiniebla, intermitencia)',
        subFields: [
          {
            key: 'foco_averiado',
            label: 'Foco averiado',
            type: 'multiselect',
            options: ['Freno Izq', 'Freno Der', 'Marcha atrás', 'Antiniebla T', 'Int. Izq T', 'Int. Der T'],
            required: true,
          },
          {
            key: 'tipo_averia_optica',
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Lente de cámara rota/opaca', 'Sin señal de video/audio en cabina', 'Sensor acústico dañado/hundido'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Bisagra descolgada', 'Fallo cierre imantado/inercial a 270º', 'Gomas de estanqueidad rotas'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Superficie antideslizante arrancada', 'Estructura doblada', 'Anclajes sueltos'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Presión baja', 'Neumático caducado/dañado', 'Mecanismo de extracción (torno) bloqueado', 'Inexistente'],
            required: true,
          },
        ],
      },
    ...
    items: [
      {
        ...
        subFields: [
          ...
          },
          {
            ...
            label: 'Tipo de anomalía',
            type: 'select',
            options: ['Presión baja', 'Pinchazo activo', 'Desgaste por debajo del testigo (1.6mm)', 'Desgaste irregular'],
          },
        ],
      },
      {
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Aceite motor', 'Líquido de frenos', 'Refrigerante', 'Valvulina/Transmisión', 'Combustible'],
            required: true,
          },
          {
            key: 'severidad_fuga',
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Eyector automático inoperativo', 'Pines quemados/sulfatados', 'Tapa de protección arrancada'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'multiselect',
            options: ['MIL (Avería Motor)', 'ABS/ESP', 'TPMS (Presión Neumáticos)', 'Sistema de Frenos', 'Batería/Alternador'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'multiselect',
            options: ['Aceite por debajo del mínimo', 'Sin líquido limpiaparabrisas', 'Combustible en reserva', 'AdBlue requiere relleno'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'select',
            options: ['Altavoz frontal roto/mudo', 'Amplificador quemado', 'Fallo en botonera/consola de control'],
            required: true,
          },
        ],
      },
      ...
      },
      {
        ...
        subFields: [
          ...
          },
          {
            ...
            label: 'Tipo de fallo',
            type: 'select',
            options: ['Compresor A/C no arranca', 'Fuga de gas/No enfría', 'Ventilador extractor/intractor roto', 'Iluminación interior fundida'],
          },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Integridad de la rotulación de alta visibilidad (patrón Battenburg) y catadióptricos',
        subFields: [
          {
          ...
          },
          {
            ...
            label: 'Tipo de fallo',
            type: 'select',
            options: ['Vinilo desprendido/arrancado', 'Pérdida total de reflectancia', 'Catadióptrico roto'],
          },
        ],
      },
    ],
        ...
        subFields: [
          {
            ...
            type: 'multiselect',
            options: ['Cable/Cuerda sintética', 'Gancho/Seguro', 'Guía (rodillos o fija)', 'Toma de conexión del mando'],
            required: true,
          },
          {
            ...
            label: 'Tipo de avería',
            type: 'select',
            options: ['Cable deshilachado/pellizcado', 'Óxido severo o mecanismo atascado', 'Embrague no engrana/desengrana', 'Seguro del gancho roto'],
          },
        ],
      },
      {
        id: 'snorkel',
        label: 'Toma de aire elevada (snorkel): integridad del conducto y capuchón libre de obstrucciones',
        soloVIR: true,
        subFields: [
          {
            ...
            label: 'Tipo de anomalía',
            type: 'select',
            options: ['Conducto rajado/fisurado (pérdida de estanqueidad)', 'Capuchón obstruido (hojas/barro)', 'Anclajes a la carrocería arrancados o sueltos'],
            required: true,
          },
        ],
      },
        ...
        subFields: [
          {
            ...
            type: 'multiselect',
            options: ['Protector de Cárter/Motor', 'Protector de Caja de Cambios', 'Protector de Caja de Transferencia', 'Protector de Depósito'],
            required: true,
          },
          {
            key: 'tipo_dano_placa',
            label: 'Tipo de daño',
            type: 'select',
            options: ['Abolladura crítica (presiona la mecánica)', 'Tornillería arrancada (placa colgando)', 'Fisura estructural'],
          },
        ],
      },
      {
        ...
        subFields: [
          {
            ...
            type: 'multiselect',
            options: ['Palieres delanteros', 'Árbol de transmisión central', 'Diferencial trasero', 'Línea de escape'],
            required: true,
          },
          {
            ...
            type: 'select',
            options: ['Ramas/Maleza gruesa enrollada', 'Alambres/Cuerdas', 'Acumulación crítica de barro solidificado'],
          },
        ],
      },
    ],
