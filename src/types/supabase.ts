...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      activaciones_matriculas_para_usuario: { Args: never; Returns: string[] }
      ...
      presencias_drp_crew_para_usuario: { Args: never; Returns: string[] }
      presencias_terminal_para_usuario: { Args: never; Returns: string }
