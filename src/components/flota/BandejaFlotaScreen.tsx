...
export function BandejaFlotaScreen() {
    ...
    <div className="mx-auto flex w-full max-w-screen-lg flex-col gap-3 p-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-display text-lg font-bold">Bandeja flota</h2>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
            ...
            <p className="font-body text-sm text-muted-foreground">No hay mensajes en la bandeja de flota.</p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-2">
