/**
 * BandejaLogisticaScreen — leafId: log_bandeja
 *
 * mensajes_bandeja.Row solo tiene `contenido` (no asunto/cuerpo/origen).
 * Se muestra el contenido completo con truncado a 2 líneas en la lista.
 */
...
export function BandejaLogisticaScreen() {
    ...
    <div className="mx-auto flex w-full max-w-screen-lg flex-col gap-3 p-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-display text-lg font-bold">Bandeja logística</h2>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
            ...
            <p className="font-body text-sm text-muted-foreground">No hay mensajes en la bandeja logística.</p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-2">
