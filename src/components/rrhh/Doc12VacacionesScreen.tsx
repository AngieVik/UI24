...
export function Doc12VacacionesScreen() {
  const { propias, pendientes, loading, submitting, error, enviarSolicitud, resolverSolicitud } =
    useVacaciones()
    ...
    return (
      ...
      >
        ...
        <p className="font-body text-sm text-muted-foreground">
          Tu solicitud de vacaciones se ha enviado a RRHH para su revisión.
        </p>
        <Button
          onClick={() => {
            setDone(false)
      ...
      <Card>
        ...
        <CardContent>
          <form
            ...
            className="space-y-4"
            noValidate
            aria-label="Formulario solicitud vacaciones"
          >
            <Controller
              ...
              <div key={s.id} className="space-y-2 rounded-md border p-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => resolverSolicitud(s.id, 'Denegada')}
                    disabled={submitting}
                  >
                    Denegar
                  </Button>
