      ...
      <DialogContent className="flex max-h-[80dvh] w-full max-w-md flex-col gap-0 p-0">
        <DialogHeader className="flex flex-row items-center justify-between border-b px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            {noLeidos > 0 && (
              <Badge variant="warn" className="text-xs">{noLeidos} sin leer</Badge>
            )}
          </div>
          <Button size="sm" variant="ghost" onClick={cargarMensajes} disabled={loading} aria-label="Recargar">
